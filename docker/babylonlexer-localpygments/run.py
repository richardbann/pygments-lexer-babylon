...
def run():
    ...
    subprocess.call([PIP_COMMAND, 'install', '-e', '/pygments-lexer-babylon/docker/babylonlexer-localpygments/pygments-main'])
    subprocess.call([PIP_COMMAND, 'install', '-e', '/pygments-lexer-babylon'])
